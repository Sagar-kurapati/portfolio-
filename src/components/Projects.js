...
const projectsData = [
  {
    ...
    description:
      'Business management platform for salons and spas with Google Calendar integration, customer management, team handling, and automated billing with real-time analytics',
    tech: ['REACT', 'NODE.JS', 'MONGODB', 'GOOGLE API'],
    icon: '📅',
    link: 'https://bookings.merchantmarvels.com/login',
  },
  {
    num: '02',
    ...
    title: 'CRM FOR SALES\nMANAGEMENT',
    description:
      'Role-based CRM system with lead tracking, sales pipeline management, email & SMS automation, and third-party integrations for enhanced workflow automation',
    tech: ['REACT', 'NODE.JS', 'MYSQL', 'API INTEGRATIONS'],
    icon: '📞',
    link: 'https://iso.ringenioussolutions.com/',
  },
  {
    num: '03',
    ...
    description:
      'Service-based website with Stripe payment integration, lead capture forms, and responsive UI for showcasing web development solutions',
    tech: ['REACT', 'NODE.JS', 'STRIPE', 'EXPRESS'],
    icon: '🌐',
    link: 'https://websolutionusa.com/',
  },
  {
    num: '04',
    ...
    description:
      'Custom clothing e-commerce platform with product personalization, cart system, order tracking, and user account management',
    tech: ['PHP', 'MYSQL', 'JQUERY', 'HTML/CSS'],
    icon: '🛍️',
    link: 'https://github.com/Sagar-kurapati/E-Commerce_Website_for_Customized_Garments',
  },
  {
    num: '05',
    ...
    title: 'REACT ADMIN\nDASHBOARD',
    description:
      'Interactive admin dashboard with charts, data grids, calendar scheduling, and form validation built using modern UI libraries',
    tech: ['REACT', 'MATERIAL UI', 'NIVO', 'FORMIK', 'YUP'],
    icon: '📊',
    link: 'https://github.com/Sagar-kurapati/React_Admin_Dashboard',
  },
];
        ...
        <div className="projects__header-inner">
          ...
          <div className="projects__header-right">
            ...
            <div className="projects__header-stat">
              ...
              <span className="projects__stat-value">2026</span>
            </div>
          </div>
        </div>
      </div>
